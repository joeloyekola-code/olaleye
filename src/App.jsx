    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-5 py-20 w-full grid lg:grid-cols-2 gap-14 items-center">
        ...
        <motion.div
          ...
          className="relative"
        >
          <img src="/images/community.jpg" alt="Community" className="w-full h-72 lg:h-[440px] object-cover rounded-2xl shadow-2xl" />
      ...
      <div className="max-w-6xl mx-auto px-5 grid lg:grid-cols-2 gap-16 items-center">
        <FadeIn direction="right">
          <div className="relative">
            <img src="/images/founder.jpg" alt="Founder Rev. Peter Olaleye" className="w-full h-96 object-cover rounded-2xl shadow-lg" />
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {stories.map(({ tag, title, body, img, imgPath, bg, accent }, i) => (
            <FadeIn key={title} delay={i * 0.15}>
              ...
              >
                <img src={imgPath || `/images/${img.toLowerCase().replace(/\s+/g, '-')}.jpg`} alt={title} className="w-full h-56 rounded-none rounded-t-3xl object-cover" />
